...
public class Sarrera extends JFrame {
    ...
    private static final String[] BUTTON_LABELS = {"Bezeroak", "Eskaerak", "Ordutegia", "EsOrdutegiak", "Eserlekuak", "Errerserba Historikoa", "Sarrerak", "Aretoak"};
